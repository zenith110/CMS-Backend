...
func (r *queryResolver) ArticlePrivate(ctx context.Context, input *model.FindArticlePrivateType) (*model.Article, error) {
	panic(fmt.Errorf("not implemented: ArticlePrivate - articlePrivate"))
}
...
func (r *queryResolver) GetGalleryImages(ctx context.Context, jwt string, username string) (*model.GalleryImages, error) {
	images, err := routes.GalleryFindImages(jwt, username)
	return images, err
}
